angular.module('starter.controllers')
    .controller('ClientViewDeliveryCtrl',
        ['$scope', '$ionicLoading', '$stateParams', 'ClientOrder','UserData','$ionicPopup',
            '$pusher','$window','$map','uiGmapGoogleMapApi',
            function($scope, $ionicLoading, $stateParams, ClientOrder, UserData, $ionicPopup, $pusher, $window, $map, uiGmapGoogleMapApi){
                ...
                ClientOrder.get({id: $stateParams.id, include: 'items,cupom'}, function(data){
                    ...
                    if(parseInt($scope.order.status,10) == 1){
                        ...
                        $ionicPopup.alert({
                            title: 'Advertencia',
                            template: 'Pedido ainda não encaminhado para entrega'
                        });
                    }
    ...
    .controller('CvdControlDescentrelize', ['$scope','$map',function ($scope, $map) {
        $scope.map = $map;
        $scope.fit = function () {
